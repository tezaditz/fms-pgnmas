...
<div class='panel panel-default'>
    ...
    <form method='post' action="{{ Route('PostEditSaveUtility' , ['table'=>'master_listrik' , 'id' => $master->id  ] )}}" enctype="multipart/form-data" class='form-horizontal'>
                ...
                {{ csrf_field() }}
                        ...
                        <div class='form-group header-group-0 ' id='form-group-foto_before' style="">
                            ...
                            <div class="col-sm-10">
                                ...
                                @else
                                    <input type="hidden" id="foto_before_text" nama="foto_before_text" value="{{ $master->foto_before }}" >
                                    <img src="{{ url($master->foto_before) }}" alt="foto_sebelum" width="20%" height="20%">
                                    <a href="{{ route('hapusfotoutilitas' , ['id' => $master->id , 'utilitas'=> 'listrik' , 'photo'=>'foto_before'  ]) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                @endif
                                    <p class='help-block'></p>
                                        <div class="text-danger"></div>
                        ...
                        <div class='form-group header-group-0 ' id='form-group-foto_after' style="">
                            ...
                            @else
                                <input type="hidden" id="foto_after" nama="foto_after" value="{{ $master->foto_after }}" >
                                    ...
                                    <a href="{{ route('hapusfotoutilitas' , ['id' => $master->id , 'utilitas'=> 'listrik' , 'photo'=>'foto_after']) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                            @endif
