  ...
  <div class='panel panel-default'>
    ...
    <div class='panel-body'>
      <form method='post' action="{{CRUDBooster::mainpath('add-save')}}" enctype="multipart/form-data" class='form-horizontal'>
        {{ csrf_field() }}
        <input type='hidden' name='return_url' value='http://127.0.0.1:8000/pgnmas/limbah'/>
        <input type='hidden' name='ref_mainpath' value='http://127.0.0.1:8000/pgnmas/limbah'/>
        <input type='hidden' name='ref_parameter' value='return_url=http://127.0.0.1:8000/pgnmas/limbah&amp;parent_id=&amp;parent_field='/>
        <div class="box-body" id="parent-form-area">
          ...
          <div class='form-group header-group-0 ' id='form-group-jenis' style="">
