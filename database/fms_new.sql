...
INSERT INTO `cms_privileges_roles` VALUES (140, 1, 1, 1, 1, 1, 5, 23, NULL, NULL);
INSERT INTO `cms_privileges_roles` VALUES (141, 1, 1, 1, 1, 1, 5, 17, NULL, NULL);
INSERT INTO `cms_privileges_roles` VALUES (142, 1, 1, 1, 1, 1, 5, 12, NULL, NULL);
INSERT INTO `cms_privileges_roles` VALUES (143, 1, 1, 1, 1, 1, 5, 15, NULL, NULL);
INSERT INTO `cms_privileges_roles` VALUES (144, 1, 1, 1, 1, 1, 5, 26, NULL, NULL);
INSERT INTO `cms_privileges_roles` VALUES (145, 1, 1, 1, 1, 1, 5, 18, NULL, NULL);
...
CREATE TABLE `rekap_pemakaian`  (
  ...
  `created_at` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 734 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
