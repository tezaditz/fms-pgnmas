...
$(document).ready(function(){
  ...
  var url = "/pgnmas/getmeterid/AIR/"+asetid+"/"+period;
  ...
  detail.empty();
    $.each(result, function (key, entry) {
      ...
      $table = $table + "<td><a href='/pgnmas/air/"+entry.id+"/edit' class='btn btn-success btn-xs'><i class='fa fa-edit'></i></a>";
      $table = $table + "</td>";
      $table = $table + "</tr>";
      detail.append($table);
