<?php namespace App\Http\Controllers;
	...
	class AdminAirController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Jenis','name'=>'jenis','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Sumur;Pam'];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			foreach ($user_aset as $key => $value) {
				...
				$query->OrderBy('master_air.aset_id' , 'asc');
	    ...
	    */
	    public function hook_before_add(&$postdata) {        
	        //Your code here
	        $cek = DB::table('master_air')->where('aset_id' , $postdata['aset_id'])
	    ...
	    */
	    ...
	    public function getAdd()
		{
			...
			$this->cbView('backend.utilitas.air.add',$data);
		}
		...
		public function getEdit($id)
		{
			...
			$master 			=  DB::table('master_air')->where('id' , $id)->first();
