<?php namespace App\Http\Controllers;
	...
	class AdminArea36Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
			$this->col[] = array("label"=>"Wilayah Id","name"=>"wilayah_id","join"=>"wilayah,id");
