<?php namespace App\Http\Controllers;
	...
	class AdminSubDetailSlaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "sub_detail_sla";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Detail Sla","name"=>"detail_sla_id","join"=>"detail_sla,uraian"];
			$this->col[] = ["label"=>"Group Sla","name"=>"group_sla_id","join"=>"group_sla,uraian"];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
	            $query->where('sub_detail_sla.tahun' , CRUDBooster::CurrYear());
	    }
