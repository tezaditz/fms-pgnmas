<?php namespace App\Http\Controllers;
	...
	class AdminRequestController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Tanggal","name"=>"tanggal" );
		...
		$this->col[] = array("label"=>"Jenis Complain","name"=>"id_jenis_complain","join"=>"jenis_complain,id");
		$this->col[] = array("label"=>"Uraian Komplain","name"=>"uraian_komplain" );
		...
		$this->form[] = ["label"=>"Waktu","name"=>"waktu","type"=>"time","required"=>TRUE,"validation"=>"required|date_format:H:i:s"];
		$this->form[] = ["label"=>"Nama Pemohon","name"=>"nama_pemohon","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		$this->form[] = ["label"=>"Unit Pelapor","name"=>"unit_pelapor","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		$this->form[] = ["label"=>"Jenis Complain","name"=>"id_jenis_complain","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"jenis_complain,id"];
		$this->form[] = ["label"=>"Uraian Komplain","name"=>"uraian_komplain","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		...
		$this->form[] = ["label"=>"Tanggal Masuk","name"=>"tanggal_masuk","type"=>"datetime","required"=>TRUE,"validation"=>"required|date_format:Y-m-d H:i:s"];
