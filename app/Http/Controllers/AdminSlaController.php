<?php namespace App\Http\Controllers;
	...
	class AdminSlaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
	    public function hook_before_delete($id) {
			//Your code here
			$data = CRUDBooster::first('sla' , $id);
			$cek = DB::table('detail_sla')->where('sla_id' , $id)->count();
			if($cek > 0)
			{
				$to = CRUDBooster::mainpath();
				$message = 'SLA "'. $data->uraian .'" Tidak Dapat DiHapus, Terdapat Detail SLA!';
				$type = 'warning';
