<?php namespace App\Http\Controllers;
	...
	class AdminSolarController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->form = [];
			...
			$this->form[] = ['label'=>'Aset','name'=>'aset_id','type'=>'select','validation'=>'required|min:0','width'=>'col-sm-10' ,'dataquery'=>'select id as value , nama as label from aset order by id' ];
	        ...
	        */
	        $this->load_js = array();
	        $this->load_js[] = asset("js/utilitas/solar/add.js");
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			foreach ($aset as $key => $value) {
				...
				$query->OrderBy('master_solar.aset_id' , 'asc');
	    ...
	    */
	    ...
	    public function getAdd()
		{
			...
			$this->cbView('backend.utilitas.solar.add',$data);
		}
