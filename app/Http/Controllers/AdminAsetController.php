<?php namespace App\Http\Controllers;
	...
	class AdminAsetController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Pln Id","name"=>"pln_id"];
			$this->col[] = ["label"=>"Pam Id","name"=>"pam_id"];
			...
			$this->form[] = ['label'=>'Type','name'=>'type','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'Bangunan;Tanah'];
			$this->form[] = ['label'=>'Volume','name'=>'volume','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Nomor PLN','name'=>'pln_id','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nomor PAM','name'=>'pam_id','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Area','name'=>'area_id','type'=>'select','validation'=>'required|min:1|max:255','width'=>'col-sm-9','datatable'=>'area,uraian'];
	        ...
	        //Your code here
				...
				switch (CRUDBooster::myPrivilegeName() ) {
					case 'Koordinator Wilayah':
						$area = [];
						$data_area = DB::table('area')->where('wilayah_id' , $wilayahid)->get(['id']);
				...
				if(CRUDBooster::myPrivilegeName() == 'Leader'){
