<?php namespace App\Http\Controllers;
	...
	class AdminListrikController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Pemakaian','name'=>'pemakaian','type'=>'money','validation'=>'required|double|min:0','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Rupiah','name'=>'rupiah','type'=>'money','validation'=>'required|double|min:0','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_query_index(&$query) {
			...
			foreach ($aset as $key => $value) {
				...
				$query->OrderBy('master_listrik.aset_id' , 'asc');
	    ...
	    */
		...
		public function getAdd()
		{
			...
			$asetid = $data_useraset->aset_id;
			$areaid = $data_useraset->area_id;
