<?php namespace App\Http\Controllers;
	...
	class AdminAreaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Wilayah Id','name'=>'wilayah_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'wilayah,uraian'];
