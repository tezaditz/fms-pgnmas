...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form autocomplete='off' action="{{ route('postLogin') }}" method="post">
            ...
            <div class="form-group has-feedback">
                <select name="year" id="year" require class='form-control'>
            ...
            <div class='row'>
            <div class='col-xs-12' align="center"><p style="padding:10px 0px 10px 0px">ver. {{ CRUDBooster::getSetting("version") }}</a></p></div>
            </div>
        </form>
